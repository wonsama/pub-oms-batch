...
public class ExcelServiceImpl implements ExcelService {
  ...
  public ByteArrayOutputStream generateExcelSheet(String id)
    ...
    createSheet2(workbook, bays, labels, infos);
    log.info("3/4 make sheet2 done");
  ...
  private List<String> getBayNmList(List<ShopBayTagDto> bays) {
   ...
   */
  private void createSheet2(XSSFWorkbook workbook, List<ShopBayTagDto> bays, List<ShopStockDto> labels,
  ...
  private void drawTagSumList(XSSFSheet sheet, XSSFWorkbook workbook, List<ShopBayTagDto> bays,
  ...
  private void drawTagSumTotal(XSSFSheet sheet, int startRow, List<ShopStockInfoDto> infos,
  ...
  private void drawTagSumInch(XSSFSheet sheet, int startRow, List<ShopStockInfoDto> infos, String inch,
  ...
  private void drawTagSumItem(XSSFSheet sheet, int startRow, List<ShopStockInfoDto> infos, int tagRdr, XSSFCellStyle s1,
      XSSFCellStyle s3) {
  ...
  private void drawErrCount(XSSFSheet sheet, XSSFWorkbook workbook, List<ShopBayTagDto> bays,
      List<ShopStockDto> labels) {
    // 고정값 설정
    final int MAX_TAG_ROWS = (int) Math.floor(getMaxLabels(labels) / 10) * 10 + 10;
  ...
  private void drawTagCategory2(XSSFSheet sheet, XSSFWorkbook workbook, List<ShopBayTagDto> bays,
      List<ShopStockDto> labels) {
